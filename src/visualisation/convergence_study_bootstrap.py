...
def converge_study(training_df, testing_df, n_bootstrapping_models:int, gb_parms: dict =  GB_PARAMETERS) -> list:
    models = []
    n_values = []
    final_means = []
    final_std = []
...
_,_,avg,n = converge_study(train_data,testing_data,50)
